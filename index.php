...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Thiết lập các tùy chọn cURL cho yêu cầu thứ hai
        curl_setopt($ch, CURLOPT_URL, "https://flux.li/android/external/check1.php");
        $response = curl_exec($ch);

        // Thiết lập các tùy chọn cURL cho yêu cầu thứ ba
        curl_setopt($ch, CURLOPT_URL, "https://flux.li/android/external/main.php");
        $response = curl_exec($ch);
        // Đóng cURL session
        curl_close($ch);
